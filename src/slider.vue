...
<style scoped>
    ...
    .v_slider__prev,
    .v_slider__next { outline: none; background:#35485d; padding: 10px 15px; border:2px solid #35485d; color:#41b883; font-size: 20px; opacity: 0.9; border-radius: 10px; position: absolute; top: 35% }
    .v_slider__next {right: 0px}
    .v_slider__prev {left: 0px}
